...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        rownr += 1
        self.state_off_button = customtkinter.CTkButton(self.state_frame, command=self.state_off_event, text = "OFF")
        ...
        self.voltages_dc_bus_short_circuit_limit_entry.insert(0,"60")

        rownr += 1
        self.energy_bank_safey_threshold_entry = customtkinter.CTkEntry(self.voltages_frame, width=50, justify="right", placeholder_text="45")
        self.energy_bank_safey_threshold_entry.grid(row=rownr, column=0, padx=(20, 0), pady=(5), sticky="new")
        self.energy_bank_safey_threshold_label = customtkinter.CTkLabel(self.voltages_frame, text="W")
        ...
        self.energy_bank_safey_threshold_entry.insert(0,"45")

        rownr += 1
        self.power_pudget_dc_input_available_power_budget_input_event_entry = customtkinter.CTkEntry(self.voltages_frame, width=50, justify="right", placeholder_text="3600 W")
        ...
        self.power_pudget_dc_input_available_power_budget_input_event_entry.insert(0,"3600")
        ...
        rownr += 1
        self.current_max_load_current_entry = customtkinter.CTkEntry(self.voltages_frame, width=50, justify="right", placeholder_text="4500 W")
        ...
        self.current_max_load_current_entry.insert(0,"4500")
        ...
        self.current_max_ess_current_entry.insert(0,"4")
        ...
        self.switches_inrush_read.grid(row=rownr, column=1, pady=5, padx=12, sticky="n")
        rownr += 1
        ...
        self.switches_load_read.grid(row=rownr, column=1, pady=5, padx=12, sticky="n")
        rownr += 1
        ...
        self.switches_share_read.grid(row=rownr, column=1, pady=5, padx=12, sticky="n")
        rownr += 1
        ...
        self.switches_input_read.grid(row=rownr, column=1, pady=5, padx=12, sticky="n")
        ...
        rownr = 0
        self.energy_cell_max_volt_entry = customtkinter.CTkEntry(self.state_of_charge_set_cell_value_frame, width=50, justify="right", placeholder_text="3")
        ...
        rownr = 0
        self.energy_bank_max_volt_entry = customtkinter.CTkEntry(self.state_of_charge_set_bank_value_frame, width=50, justify="right", placeholder_text="90")
        ...
        rownr += 1
        self.energy_bank_const_volt_threshold_entry = customtkinter.CTkEntry(self.state_of_charge_set_bank_value_frame, width=50, justify="right", placeholder_text="90")
        ...
        self.energy_bank_const_volt_threshold_entry.insert(0,"80")
        ...
        rownr += 1
        self.energy_bank_trickle_charge_threshold_entry = customtkinter.CTkEntry(self.state_of_charge_set_bank_value_frame, width=50, justify="right", placeholder_text="30")
        ...
        self.energy_bank_trickle_charge_threshold_entry.insert(0,"25")
    ...
    def bank_safey_threshold_event(self):
        ...
        energy_bank.set_data_byte4(high_byte(value))
        energy_bank.set_data_byte5(low_byte(value))
        energy_bank.sendCanMessage()
    ...
    def state_off_event(self):
        print("state_button OFF click")
        state.ccs=0x2F
        state.setSubIndex(OD.S_DPMU_OPERATION_REQUEST_STATE)
        state.set_data_byte4(0) # state_off
    ...
    def state_regulate_event(self):
        ...
        state.ccs=0x2F
        state.setSubIndex(OD.S_DPMU_OPERATION_REQUEST_STATE)
        state.set_data_byte4(11) # state_regulate
        state.sendCanMessage()
...
if __name__ == "__main__":
    ...
    heartbeat     = canOD(id=0x601, ccs=0x2B, indexHigh=high_byte(OD.I_PRODUCER_HEARTBEAT_TIME), indexLow=low_byte(OD.I_PRODUCER_HEARTBEAT_TIME), subIndex=0)
    state         = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_DPMU_STATE),              indexLow=low_byte(OD.I_DPMU_STATE),              subIndex=OD.S_DPMU_OPERATION_REQUEST_STATE, data_byte4=0)
    reboot        = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_SEND_REBOOT_REQUEST),     indexLow=low_byte(OD.I_SEND_REBOOT_REQUEST),     subIndex=0) # FIXME NOT IN OD
    # nmt           = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_SWITCH_STATE),            indexLow=low_byte(OD.I_SWITCH_STATE),            subIndex=OD.S_SW_QSB_STATE) # sent using canopen_DPMU_A.write_raw()

    switch_share  = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_SWITCH_STATE), indexLow=low_byte(OD.I_SWITCH_STATE), subIndex=OD.S_SW_QSB_STATE) # SW_Qsb_State     - GLOAD_3 - J7.16
    switch_load   = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_SWITCH_STATE), indexLow=low_byte(OD.I_SWITCH_STATE), subIndex=OD.S_SW_QLB_STATE) # SW_Qlb_State     - GLOAD_2 - J9.5
    switch_input  = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_SWITCH_STATE), indexLow=low_byte(OD.I_SWITCH_STATE), subIndex=OD.S_SW_QINB_STATE) # SW_Qinb_State    - GLOAD_4 - J7.18
    switch_inrush = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_SWITCH_STATE), indexLow=low_byte(OD.I_SWITCH_STATE), subIndex=OD.S_SW_QINRUSH_STATE) # SW_Qnrush_State     - GLOAD_1 - J9.3

    voltages_max_allowed_dc_bus_voltage = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_DC_BUS_VOLTAGE), indexLow=low_byte(OD.I_DC_BUS_VOLTAGE), subIndex=OD.S_MAX_ALLOWED_DC_BUS_VOLTAGE)
    voltages_min_allowed_dc_bus_voltage = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_DC_BUS_VOLTAGE), indexLow=low_byte(OD.I_DC_BUS_VOLTAGE), subIndex=OD.S_MIN_ALLOWED_DC_BUS_VOLTAGE)
    voltages_target_voltage             = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_DC_BUS_VOLTAGE), indexLow=low_byte(OD.I_DC_BUS_VOLTAGE), subIndex=OD.S_TARGET_VOLTAGE_AT_DC_BUS)
    voltages_dc_bus_short_circuit_limit = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_DC_BUS_VOLTAGE), indexLow=low_byte(OD.I_DC_BUS_VOLTAGE), subIndex=OD.S_VDC_BUS_SHORT_CIRCUIT_LIMIT)

    power_pudget_dc_input               = canOD(id=0x601, ccs=0x2B, indexHigh=high_byte(OD.I_POWER_BUDGET_DC_INPUT), indexLow=low_byte(OD.I_POWER_BUDGET_DC_INPUT), subIndex=0)
    current_max_load_current            = canOD(id=0x601, ccs=0x2B, indexHigh=high_byte(OD.I_MAXIMUM_ALLOWED_LOAD_POWER), indexLow=low_byte(OD.I_MAXIMUM_ALLOWED_LOAD_POWER), subIndex=0)
    current_max_ess_current             = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_ESS_CURRENT), indexLow=low_byte(OD.I_ESS_CURRENT), subIndex=0)
    read_power                          = canOD(id=0x601, ccs=0x40, indexHigh=high_byte(OD.I_READ_POWER), indexLow=low_byte(OD.I_READ_POWER), subIndex=0)

    energy_cell                         = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_ENERGY_CELL_SUMMARY), indexLow=low_byte(OD.I_ENERGY_CELL_SUMMARY), subIndex=0)
    energy_bank                         = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_ENERGY_BANK_SUMMARY), indexLow=low_byte(OD.I_ENERGY_BANK_SUMMARY), subIndex=0)

    temperature                         = canOD(id=0x601, ccs=0x40, indexHigh=high_byte(OD.I_TEMPERATURE), indexLow=low_byte(OD.I_TEMPERATURE), subIndex=0)

    debuglog                            = canOD(id=0x601, ccs=0x40, indexHigh=high_byte(OD.I_DEBUG_LOG), indexLow=low_byte(OD.I_DEBUG_LOG), subIndex=0)
    canlog                              = canOD(id=0x601, ccs=0x40, indexHigh=high_byte(OD.I_CAN_LOG), indexLow=low_byte(OD.I_CAN_LOG), subIndex=0)
    log                                 = canOD(id=0x601, ccs=0x40, indexHigh=high_byte(OD.I_CAN_LOG), indexLow=low_byte(OD.I_CAN_LOG), subIndex=0)
    time                                = canOD(id=0x601, ccs=0x40, indexHigh=high_byte(OD.I_DATE_AND_TIME), indexLow=low_byte(OD.I_DATE_AND_TIME), subIndex=0)

    store_od                            = canOD(id=0x601, ccs=0x23, indexHigh=high_byte(OD.I_STORE_PARAMETERS), indexLow=low_byte(OD.I_STORE_PARAMETERS), subIndex=0,
                                                data_byte4=0x73, data_byte5=0x61, data_byte6=0x76, data_byte7=0x65)
    restore_od                          = canOD(id=0x601, ccs=0x23, indexHigh=high_byte(OD.I_RESTORE_DEFAULT_PARAMETERS), indexLow=low_byte(OD.I_RESTORE_DEFAULT_PARAMETERS), subIndex=0,
                                                data_byte4=0x6C, data_byte5=0x6F, data_byte6=0x61, data_byte7=0x64)
    dpmu_type_od                         = canOD(id=0x601, ccs=0x2F, indexHigh=high_byte(OD.I_DPMU_POWER_SOURCE_TYPE), indexLow=low_byte(OD.I_DPMU_POWER_SOURCE_TYPE), subIndex=0)
