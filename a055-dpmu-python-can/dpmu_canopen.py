...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.current_max_load_current_entry.insert(0,"500")
        ...
        self.energy_cell_max_volt_entry.insert(0,"2")
        ...
        self.energy_bank_max_volt_entry.insert(0,"60")
        ...
        self.energy_bank_const_volt_threshold_entry.insert(0,"60")
        ...
        self.energy_bank_trickle_charge_threshold_entry.insert(0,"40")
